                            ...
                            <div class="panel-body">
                                <div class="form-horizontal form-border" role="form" onkeypress="return runScriptActData(event)">
                                    <div class="form-group">
                                        <?php 
                                            $cedula = explode('-',$_users[$_SESSION['app_id']]['cedula']);
                                            $telefono = explode('+58',$_users[$_SESSION['app_id']]['telefono']);
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="users_act" id="users_act" required="" placeholder="Login" value="<?php echo $_users[$_SESSION['app_id']]['login']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Correo electronico : </label>
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control " required="" name="email" id="email" placeholder="Correo electronico" value="<?php echo $_users[$_SESSION['app_id']]['correo']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Primer nombre : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="primer_nom_act" id="primer_nom_act" required="" placeholder="Primer nombre" value="<?php echo $_users[$_SESSION['app_id']]['primer_nombre']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Segundo nombre : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="seg_nom_act" id="seg_nom_act" required="" placeholder="Segundo nombre" value="<?php echo $_users[$_SESSION['app_id']]['segundo_nombre']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Primer apellido : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required="" name="primer_ape_act" id="primer_ape_act" placeholder="Primer apellido" value="<?php echo $_users[$_SESSION['app_id']]['primer_apellido']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Segundo apellido : </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required="" name="seg_ape_act" id="seg_ape_act" placeholder="Segundo apellido" value="<?php echo $_users[$_SESSION['app_id']]['segundo_apellido']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control" required="" name="fecha" id="fecha" value="<?php echo $_users[$_SESSION['app_id']]['nacimiento']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sexo : </label>
                                        <div class="col-sm-6">
                                            <?php if($_users[$_SESSION['app_id']]['sexo'] == '0'){ ?>
                                            <div class="radio">
                                            ...
                                            <?php }elseif($_users[$_SESSION['app_id']]['sexo'] == '1'){ ?>
                                            <div class="radio">
                                            ...
                                            <?php }elseif($_users[$_SESSION['app_id']]['sexo'] == '2'){ ?>
                                            <div class="radio">
                                                <input class="icheck" type="radio" name="optionsSex" id="optionsSex1" value="0" >
                                                <label>Mujer</label>
                                            </div>
                                            ...
                                            <?php }elseif($_users[$_SESSION['app_id']]['sexo'] == '3'){ ?>
                                            <div class="radio">
                                                <input class="icheck" type="radio" name="optionsSex" id="optionsSex1" value="0" >
                                                <label>Mujer</label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="password" class="form-control" name="pri_con_act" id="pri_con_act" required="" placeholder="Contraseña">
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-7 col-sm-4">
                                            <button type="submit" onclick="goCambioData()" class="btn btn-block btn-primary">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
